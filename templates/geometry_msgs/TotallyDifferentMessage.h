...
{
	class TotallyDifferentMessage : public FROSBridgeMsg
	{
	...
	public:
		...
		~TotallyDifferentMessage() override {}
		...
		static TotallyDifferentMessage GetFromJson(TSharedPtr<FJsonObject> JsonObject)
		{
			TotallyDifferentMessage Result;
